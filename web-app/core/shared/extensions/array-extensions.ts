export const arrayExtensions = true
...
Array.prototype.last = function last<T>(
  ...
  for (let i = this.length - 1; i >= 0; i--)
    if (!selector || selector(this[i])) return this[i]
  return undefined
}
...
Array.prototype.any = function any<T>(this: T[], selector: (x: T) => boolean) {
  for (const e of this) if (selector(e)) return true
  return false
}

Array.prototype.all = function all<T>(this: T[], selector: (x: T) => boolean) {
  for (const e of this) if (!selector(e)) return false
  return true
}
...
Array.prototype.groupInto = function groupInto<T, K>(
  this: T[],
  keySelector: (x: T) => K,
): { key: K; items: T[] }[] {
...
Array.prototype.filterNull = function filterNull<T>(
  this: (T | null | undefined)[],
): T[] {
  return this.filter((x) => x != null) as T[]
}

Array.prototype.filterFalsy = function filterFalsy<T>(
  this: (T | null | undefined)[],
): T[] {
  return this.filter(Boolean) as T[]
}

Array.prototype.updateWith = function updateWith<T>(
  this: T[],
  newData: T[],
...
Array.prototype.isEqual = function isEqual(
  this: string[],
  other: string[],
): boolean {
...
Array.prototype.pushDistinct = function pushDistinct<T>(
  this: T[],
  ...elements: T[]
): void {
...
Array.prototype.intersection = function intersection<T>(
  this: T[],
  other: T[],
): T[] {
...
Array.prototype.joinStr = function joinStr(
